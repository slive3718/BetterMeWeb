		...
		<div class="card" style="width: 50rem; max-width: 100%;">
			...
			<div class="card-body">
				<span style="" class="btn btn-success form-control"><span style="float:left">
					...
					</span>	<button id="report-post" data-session_id = "<?=$post_id?>" data-post_user_id = "<?=$post_user_id?>" data-post_type = "diet_plan"  style="float: right; margin-left: 30px; border-radius: 50%; cursor: pointer" class="fa fa-times-circle btn-danger btn-sm"  data-toggle="modal" data-target="#modal-report-post"></button>
