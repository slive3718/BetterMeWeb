  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    ...
    <div class="container">
        <div class="row">
        	...
        	<div class="col-sm-2"><a href="<?= base_url().'user/viewMyProfileInfo'?>" class="pull-right"><img title="Update Profile" class="img-circle img-responsive" src="<?=base_url().'/assets/images/update-profile-icon.png'?>" ></a></div>
        </div>
        <div class="row">
                      ...
                      <form class="form" action="<?=base_url('user/updateMyProfileInfo/'.$id)?>" method="POST" id="registrationForm">
						  ...
						  <div class="form-group">
							  <div class=" col-xs-6">
								  ...
								  <div class="input-group">
									  <input type="text" name= "weight" class="form-control" id="inputGroupSuccess2" aria-describedby="" value="<?php if($weight){echo $weight;}?>">
						  ...
						  <div class="form-group">
							  <div class=" col-xs-6">
								  ...
								  <div class="input-group">
									  <input type="text" name="height" class="form-control" id="inputGroupSuccess2" aria-describedby="" value="<?php if($height){echo $height;}?>">
