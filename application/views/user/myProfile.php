						...
						<?php }else{ ?>
							<div class="m-mrg card Regular shadow" id="archived-section_<?=$my_post_id?>" class="">
								<div>
									<div class="post card Regular shadow">
										<div class="tb">
											<div style="text-align: center; font-weight: bold; font-size: 25px"> Sorry, This content isn't available right now:<br><a style="font-size: 15px; text-align: center;">"When this happens, it's usually the post is unavailable or deleted due to contents against our rules and standard. "</a></div><span class="mark-read-warning" style="cursor: pointer;color: blue; font-weight: bold;" data-post_id="<?=$my_post_id?>">Ok! Mark as read</span>
										</div>
									</div>
								</div>
							</div>
