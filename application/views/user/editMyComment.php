                ...
                <form method="POST" action="<?= base_url().'user/updateMyComment/',$comment_id?>">
                        <div>
                           ...
                           <input type="text" name="community_id" value="<?= $community_id?>" hidden>
                                ...
                                <textarea class="form-control ml-5 mr-5 shadow-none textarea" wrap="hard" cols="10" row="10" name="community_comment" ><?php if (isset($comment_content)){ echo $comment_content;}?></textarea>
