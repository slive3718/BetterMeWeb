                ...
                <form method="POST" action="<?= base_url().'user/updateMyComment/',$comment_id?>">
                        <div>
                           ...
                           <input type="text" name="community_id" value="<?= $community_id?>" hidden>
                                ...
                                <textarea class="form-control ml-5 mr-5 shadow-none textarea" wrap="hard" rows="10" cols="10"  name="community_comment"><?php if (isset($comment_content)){ echo $comment_content;}?></textarea>
                            ...
                            <a class="btn btn-danger btn-xs fas fa-window-close  fa-xs" href="<?= base_url().'user/view_this_community_post/',$community_id?>">Cancel</a></div></div>
                                            </div>
