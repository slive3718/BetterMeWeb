...
<main>
        ...
        <header>
            ...
            $sex=$val->sex;
                 ...
                 ?>
                <div class="td" id="f-name-l"><span><?=(isset($firstName) && !empty($firstName))?$firstName:$username?><a style="color:white" class="btn btn-s btn-success rounded"
												   href="<?= base_url() . 'user/myProfile/' . $id ?>"><?= Ucfirst($firstName) ?></a></span></div>
