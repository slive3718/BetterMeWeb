		...
		<div class="col-md-12">
			<div class="table-striped table-responsive">
				<table class="table table-striped " id="posts-table" style=" text-align: center">
					...
					<th style="text-align: center">List Of Posts</th>
					</thead>
					<tbody>
					<?php if(isset($posts) && !empty($posts) ){
						foreach ($posts as $post){?>
					<tr>
						<td>Post Title: <?=$post->post_title?> <br> Post Content: <?=$post->post_content?> <br> Link : <a href="<?=base_url().'user/viewFullDiet/'.$post->post_id?>" class=""> View </a>
						</td>
