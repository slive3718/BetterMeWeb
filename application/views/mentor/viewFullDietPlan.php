...
?>
                ...
                <a href="<?= base_url().'mentor/edit_Diet/'.$post_id?>" class="btn  btn-sm btn-primary">Edit</a>
          <!-- Button trigger modal -->
              ...
              <div class="d-flex">
                ...
                <a href="<?=base_url().'mentor/post_like/'.$post_user_id.'/'.$current_user?>">Like</a></div> <div><a href=""> Comment </a></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="<?= base_url().'mentor/editPosts/'.$post_id?>">Confirm</button>
      </div>
    </div>
  </div>
</div>
