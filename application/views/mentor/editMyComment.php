                ...
                <form method="POST" action="<?= base_url().'mentor/updateMyComment/',$comment_id?>">
                        <div>
                           ...
                           <input type="text" name="community_id" value="<?= $community_id?>" hidden>
                                ...
                                <textarea class="form-control ml-5 mr-5 shadow-none textarea" rows="10" cols="10" name="community_comment" >
                            ...
                            <a class="btn btn-danger btn-xs fas fa-window-close  fa-xs" href="<?= base_url().'mentor/view_this_community_post/',$community_id?>">Cancel</a></div></div>
                                            </div>
