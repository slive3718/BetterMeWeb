...
<form
    action="<?=base_url().'mentor/add_community_comment/'.$community_post_id?>"
    method="POST">
                        ...
                        <div class="d-flex flex-row-reverse">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a
                                        class="dropdown-item"
                                        href="<?= base_url().'mentor/editMyCommunityThread/',$community_post_id?>">Edit</a>
                                <?php }?>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            ?>
                                <a
                                    ...
                                    href="<?= base_url().'mentor/editMyComment/',$comment_id?>"></a>
                                <a
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary"  href="<?= base_url().'mentor/deleteMyComment/',$comment_id.'/'.$community_post_id?>
        ">Confirm</a>
      </div>
    </div>
  </div>
