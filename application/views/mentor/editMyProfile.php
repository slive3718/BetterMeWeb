  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    ...
    <div class="container">
        <div class="row">
        	...
        	<div class="col-sm-2"><a href="<?= base_url().'mentor/viewMyProfile'?>" class="pull-right"><img title="Update Profile" class="img-circle img-responsive" src="<?=base_url().'/assets/images/update-profile-icon.png'?>" ></a></div>
        </div>
        <div class="row">
          ...
          <div class="text-center">
              ...
              <?php
               ...
               <?php }else{
                   ?>
                    <img src="https://www.linkpicture.com/q/avatarprofile.png" class="avatar img-circle img-thumbnail" style="height:225px;width:225px"  alt="avatar">
                   <?php
               }
...
<h6>Update your photo...</h6>
            <a href="<?php echo base_url('mentor/upload_profilepic') ?>">Update Picture</a>
          </div></hr><br>
        	...
        	<div class="col-sm-9">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <hr>
                      <form class="form" action="<?=base_url('mentor/updateMyProfile/'.$id)?>" method="POST" id="registrationForm">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-xs-6">
                                <label for="contact_no"><h4>Contact Number</h4></label>
                                  <input type="number" class="form-control" name="contact_no"  id="contact_no" value="<?php if(isset($contact)){echo $contact;}?>" placeholder="Contact Number" title="enter your last name if any.">
                              </div>
                          </div>
