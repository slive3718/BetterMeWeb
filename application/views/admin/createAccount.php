	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?= base_url().'admin/signUp'?> " method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Account type Is Required" hidden>
						<input class="input100" type="text" name="account_type" placeholder="Username" value="1">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="<?=base_url()?>admin/viewLogin">
