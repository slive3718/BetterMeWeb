		...
		<script>
			$(document).ready(function () {
				...
				$('.btn-comment-post').on('click',function(){
					...
					var comment_url = "<?= base_url().'admin/addCommentHomepage'?>";
					var postId = $(this).attr('data-post_id');
				...
				$('.comment').on('click','#delete-comment',function(){
					...
					var delete_url = "<?= base_url().'admin/deleteMyCommentHomepage'?>";
				...
				$('.update-here').on('click','.btn-comment-update',function(){
					...
					var comment_url = "<?= base_url().'admin/updateCommentHomepage'?>";
					var postId = $(this).attr('data-post_id');
