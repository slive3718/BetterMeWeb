...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="<?= base_url();?>assets/vendor/animate/animate.css">
        <!--===============================================================================================-->
        <link
            rel="stylesheet"
            type="text/css"
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="<?= base_url();?>assets/vendor/select2/select2.min.css">
        <!--===============================================================================================-->
        <link
            rel="stylesheet"
            type="text/css"
            href="<?= base_url();?>assets/css/util.css">
        <link
            rel="stylesheet"
            type="text/css"
            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form
                        ...
                        action="<?= base_url().'admin/validateUser'?>"
                        method="POST">
					 ...
					 ?> <div class="wrap-input100 validate-input btn-danger rounded"> <?= $this->session->flashdata('msgerror').'</div>';
                        ...
                        <div class="text-center p-t-136">
                            ...
                            <a class="txt2" href="<?=base_url()?>admin/viewSignUp">
                                Create Account
                                <i class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
                            </a>
                            <br>
                            <a class="txt2" style="left:10px" href="<?=base_url()?>admin/gotoUser">
                                UserPage
                                <i class="fa fa-long-arrow-down m-l-5" aria-hidden="true"></i>
                            </a>
