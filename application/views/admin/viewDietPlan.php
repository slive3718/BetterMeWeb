...
?><br>
         <button style="" class="btn btn-sm btn-success"onclick="document.location='<?= base_url().'admin/addDietPlan/'.$post_type?>'">Add Diet Plan</button>
...
<tbody >
          <tr>
            ...
            <td> <a href="<?= base_url().'admin/edit_Diet/'.$post_id?>" class="btn  btn-sm btn-primary">Edit</a>    </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location.href='<?= base_url().'admin/archive_post/'.$post_id?>'">Confirm</button>
      </div>
    </div>
  </div>
</div>
