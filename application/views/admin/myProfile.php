	...
	foreach($myInfo as $info){
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-2"><a href="<?= base_url().'admin/editMyProfile'?>" class="pull-right"><img title="Update Profile" class="img-circle img-responsive" src="<?=base_url().'./assets/images/update-profile-icon.png'?>" ></a></div>
			</div>
			<div class="row">
