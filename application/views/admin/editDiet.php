...
?>
<form action="<?= base_url().'admin/update_dietPlan'?>" method="POST" enctype="multipart/form-data">
    <center>
            ...
            <tr>
                <td>
                    ...
                    <tr>
                            ...
                            <tr>
                                <td><label>PostId</label><input class="form-control" type="text" name="post_id" value="<?php if (isset($post_id)){
                                    echo $post_id; 
                                } ?>" readonly></td>
                            </tr>
