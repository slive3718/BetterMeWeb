  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    ...
    <div class="container">
        <div class="row">
        	...
        	<div class="col-sm-2"><a href="<?= base_url().'admin/viewMyProfile'?>" class="pull-right"><img title="Update Profile" class="img-circle img-responsive" src="<?=base_url().'/assets/images/update-profile-icon.png'?>" ></a></div>
        </div>
        <div class="row">
...
<h6>Update your photo...</h6>
            <a href="<?php echo base_url('admin/upload_profilepic') ?>">Update Picture</a>
          </div></hr><br>
        	...
        	<div class="col-sm-9">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <hr>
                      <form class="form" action="<?=base_url('admin/updateMyProfile/'.$id)?>" method="POST" id="registrationForm">
