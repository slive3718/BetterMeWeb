				...
				<div class="card" style="width:30rem;height:35rem">
					...
					<div class="card-body">
						...
						style="background-color: #28A745; color:white;text-align: center">
							...
							<div>
								<?= (isset($type_of_diet) && !empty($type_of_diet) && ($type_of_diet)!="Other Diet") ? '<span style="float:left">Type of Diet: </span><span style="float:left">'.$type_of_diet.'</span><br>':' '?>
								<?= (isset($other_diet) && !empty($other_diet))? '<span style="float:left">Type of Diet: (Other Diet)</span><span style="float:left">'.$other_diet.'</span><br>':' '?>
								<?= ((isset($routine_count) && !empty($routine_count)) && (isset($routine_format) && !empty($routine_format)))? '<span style="float:left">Routine: </span><span style="float:left">'.$routine_count.' '.$routine_format.'</span><br>':' ';?>
								<?= ((isset($target_audience) && !empty($target_audience)) && (isset($target_audience) && !empty($target_audience))) ? '<span style="float:left">Suitable For: </span><span style="float:left">'.$target_audience.'</span><br>' :' '; ?>
							</div><br>
							<p class="card-text ">
