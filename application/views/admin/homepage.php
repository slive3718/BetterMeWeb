		...
		<div class="shadow-lg p-3 mb-5 ml-5 responsive" style="display:inline-block;right:20px;" >
						...
						<tr>
							<td>
								<span style="float:left !important; font-weight:bold;"><a
											href="<?= base_url() . 'admin/viewFullDiet/' . $diets->post_id ?>"><?= $diets->post_title ?></a></span>
							</td>
							<td>
			...
			<div class="card-body">
				...
				<button class="btn btn-success btn-sm"
						onclick="window.location.href='<?= base_url() . 'admin/create_thread' ?>'"
						style="float:right">
					Create a Thread
				</button>
				<br><br>
							...
							<tr>
								<td>
									<span style="float:left; font-weight:bold;"><a
												href="<?= base_url() . 'admin/view_this_community_post/' . $community_post_id ?>">
...
<script>
	$(document).ready(function () {
		$('.like').on('click', function () {
			...
			console.log(postId);
			var base_url = "<?= base_url() . 'admin/likeHomepagePost'?>";
